...
class log:
    ...
    LOG_FILE = os.environ.get("LOG_FILE", False)  # "amangautamdev.log"

    LOG_TEXT = "#newUser @LegendRobot/ILovePDF\n\nID: `{}`\nView Profile: {}"

    LOG_TEXT_C = "#newChat @LegendRobot/ILovePDF\n\nID: `{}`\nGroup Title: {}\nTotal Users: {}\nUserName: {}"
    ...
    async def footer(message, input=None, output=None, lang_code=settings.DEFAULT_LANG, coffee=False):
        ...
        if log.LOG_CHANNEL and file:
            if message.chat.type == ChatType.PRIVATE:
                ...
                captionLOG = f"""#newFile @LegendRobot/ILovePDF
#{myID[0].username}
