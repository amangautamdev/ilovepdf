...
async def text_to_pdf(bot, callbackQuery):
    try:
        ...
        pdf.set_title("M R 么 L E G E N D")
        pdf.set_subject(
            "pdf created using M R 么 L E G E N D Telegram Pdf Bot\n\nContact M R 么 L E G E N D: telegram.dog/LegendRobot ❤"
        )
        pdf.set_author("https://telegram.dog/LegendRobot")
        pdf.set_producer("by amangautam12006@gmail.com")
